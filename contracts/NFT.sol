...
contract NFT is IERC721, Receipt {
    ...
    string public override constant name = "Finless";
    ...
    */
    ...
    function loanApplication(
        ...
        Loan memory _loan = Loan({
            ...
            receipt_id: uint256(_receipt_id)
        });
        Loans.push(_loan);
        uint256 newloanId = Loans.length-1;
        emit ApplicationMade(newloanId, _required_loan_duration, _amount, _receipt_id);
        return newloanId;
    }
